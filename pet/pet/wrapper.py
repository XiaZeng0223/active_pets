...
from transformers import InputExample, AdamW, get_linear_schedule_with_warmup, PreTrainedTokenizer, \
    BertForMaskedLM, BertConfig, BertForSequenceClassification, BertTokenizer, \
    RobertaForMaskedLM, RobertaConfig, RobertaForSequenceClassification, RobertaTokenizer, \
    XLMRobertaForMaskedLM, XLMRobertaConfig, XLMRobertaForSequenceClassification, XLMRobertaTokenizer,\
    XLNetConfig, XLNetForSequenceClassification, XLNetTokenizer, XLNetLMHeadModel, \
    AlbertForSequenceClassification, AlbertForMaskedLM, AlbertTokenizer, AlbertConfig, \
    GPT2Config, GPT2LMHeadModel, GPT2Tokenizer, \
    AutoModelForMaskedLM, AutoModelForSequenceClassification, AutoTokenizer, AutoConfig, \
    DebertaForMaskedLM, DebertaForSequenceClassification, DebertaTokenizer, DebertaConfig, \
    BartForCausalLM, BartForSequenceClassification, BartTokenizer, BartConfig, \
    LongformerConfig, LongformerTokenizer, LongformerForSequenceClassification, LongformerForMaskedLM
...
MODEL_CLASSES = {
    ...
    'bart': {
        ...
        SEQUENCE_CLASSIFIER_WRAPPER: BartForSequenceClassification,
        MLM_WRAPPER: BartForCausalLM
    },
    'longformer': {
