...
from src_pet import setup, train, sample, cluster
...
def acquire(pool, sampled, args, model, tokenizer):
    ...
    [sampled] data."""
    scores_or_vectors = sample.pool_scores_or_vectors(pool, args, model, tokenizer)
    ...
    if clustering is not None:
        ...
        print('queries_unsampled', queries_unsampled)
