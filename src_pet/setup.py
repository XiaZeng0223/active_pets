...
from src_pet.data import processors, output_modes
...
def get_args():
    ...
    parser.add_argument("--sampling_seed", type=int, default=None, help="random seed for sampling with rand")
    parser.add_argument("--pooling", type=str, default='cls', help="pooling strategy to obtain text embedings")
    parser.add_argument(
        "--fp16",
        action="store_true",
    ...
    parser.add_argument("--require_inverse", action="store_true", help="do inverse weight wrt the sampled label distribution.")
